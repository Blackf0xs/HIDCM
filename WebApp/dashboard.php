...
<?php
        ...
        if($countQ1 > 0) {
            # query last 5 records on hajj information 
            $q1 = $con->prepare("SELECT * FROM `haj_info` order by `id` DESC limit 0,5");
            $q1->execute();
            
            print "<font color='red'><b><center>Recent Registration Information</center></b></font><br>";
